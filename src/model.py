...
class MACEModel(nn.Module):
    ...
    DNA, RNA, and protein sequence embeddings and output a prediction (classification or regression).
    """
    def __init__(self, input_size=128, hidden_size=64, output_size=1):
        ...
        Parameters:
            input_size (int): The total size of the input vector after concatenating all three modalities.
